...
import MahadevBatch from "./pages/MahadevBatch";
    ...
    <div>
      ...
      <Router>
        <Routes>
          ...
          <Route exact path="/pap" element={<Pap />} />
          ...
          <Route exact path="/da-ds-bootcamp" element={<MahadevBatch />} />
