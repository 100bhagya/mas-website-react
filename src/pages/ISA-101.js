      ...
      <div className="md:mt-32">
        ...
        <div className="flex flex-col-reverse md:flex-row justify-center">
          ...
          <div className="mt-10 lg:ml-44 md:ml-24 ml-3">
            <div className="py-2 md:px-20 text-center md:text-left w-[95%] md:w-full border-[2px] border-solid border-black">
              Your Salary Per Month
            </div>

            <div className="flex md:w-[20%]">
              <div className="py-2 md:px-12 px-10 border-[2px] border-solid border-black">
