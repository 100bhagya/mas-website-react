...
const IncomeSlab = ({ income, status, color, round }) => {
  return (
    <div
      className={`flex w-full md:h-[75px] pb-4 md:pb-0 pt-1 md:bg-card border-solid border-b-[1px] ${color} ${round}`}
    >
    ...
    <div className="bg-back">
      ...
      <div className="lg:flex pt-28 bg-gradient-to-b from-blue-200 via-blue-100 to-blue-50 text-center justify-center">
        <div className="lg:pt-16 pb-20 lg:bottom-12">
          ...
          <p className="relative lg:top-12 md:text-[16px] font  text-black md:leading-8 mt-10 md:mt-0 text-[13px] px-6 md:px-64 justify-center text-center">
      ...
      <div className="flex flex-col-reverse md:flex-row relative md:left-[9%] mt-24">
        <div className="md:w-[45%] w-[83%] md:bg-card mt-12 md:mt-0 text-center md:text-left md:pr-28 md:text-lg mx-8 md:mx-0 text-[12px] md:pt-36 md:pl-12 rounded-l-2xl">
        ...
        <img
          src={Artboard1}
          alt="artboard"
          className="md:bg-card md:pr-12 md:py-12 px-8 md:px-0 md:rounded-r-2xl"
        />
      </div>

      <div className="md:bg-card md:w-[59%] relative md:left-[11%] mt-20 md:ml-36 md:pt-8 md:px-20 px-5 pb-16 rounded-2xl">
      ...
      <div className="relative md:left-[21%] md:mb-20 md:mt-28 mt-6">
        <div className="md:w-7/12 md:shadow-2xl mx-4 md:mx-0">
      ...
      <div className="md:mt-28 mt-16 md:mb-40 mb-10">
        ...
        <div className="faqs md:w-[58%] relative md:left-[21%] md:bg-white md:py-10 py-5 md:px-20 rounded-3xl">
          {faqs.map((faq, i) => (
