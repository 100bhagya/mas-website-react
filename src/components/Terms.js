      ...
      <div className="bg-white lg:w-[55%] md:w-[80%] fixed text-[10px] md:text-sm top-[100px] md:top-[200px] md:left-[100px] lg:top-[100px] lg:left-[500px] p-2 md:p-10 z-50 rounded-2xl shadow-2xl">
        ...
        <div className="overflow-y-auto h-[60vh]">
          ...
          <div>
            ...
            the original purchaser of content sold on My Analytics School, you
            are entitled to access and use the content which is identified in
            the course and which is on the My Analytics School website, at
            www.myanalyticsschool.com ("Website"). In order to access and use
            this content, you must register with My Analytics School and create
            a password to use in accessing the content on the Website. Your
            password is unique and exclusive to you, and you may not transfer
            your password to any other person or allow any other person to use
            your password to access or use the content on the Website. You agree
            to notify My Analytics School immediately if any other person makes
            unauthorized use of your password. My Analytics School reserves the
            right to suspend or revoke your password in the event of any misuse
            of your password or any use of your password in violation of these
            Terms and Conditions. In the event of any such suspension or
            revocation, you will not be entitled to any refund or payment. These
            Terms of Use govern your access to and use of the Website and the
            content on the Website. By accessing and using the Website, you
            agree to these Terms of Use. If you do not agree to any of these
            Terms of Use, you may not access or use the site. My Analytics
            School reserves the right to modify these Terms of Use at any time
            ...
            modifications. Upon registration, My Analytics School grants you a
            non-exclusive, non-transferable, non-assignable, personal license to
            access and use the My Analytics School content identified in the
            content you purchased via an online/offline reader. My Analytics
            School will not be liable for any delay or interruption in your
            ...
            majeure or other failure of performance. My Analytics School will
            use reasonable efforts to correct any failure of performance, but My
            Analytics School will not be required to make any changes to any
            equipment or software used by My Analytics School or its contractors
            or agents to ensure compatibility with any equipment or software
            used by you. You may not use the site or the content on the site for
            any commercial purpose, including but not limited to the use of any
            of the content to market or sell goods or services to any person.
            You agree not to launch any automated system, including without
            limitation, "robots," "spiders," or "offline readers," to access the
            site. My Analytics School reserves the right to change, suspend
            access to, or remove any or all of the content on the Website at any
            time, for any reason, in its sole discretion. My Analytics School
            also reserves the right to discontinue the Website at any time,
            either temporarily or permanently. In the event of the removal of
            any content from the Website or the termination of the Website, you
